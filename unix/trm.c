...
Hidden Procedure getcaps(register char **parea) {
...
/*ARGSUSED*/
Hidden Procedure countchar(char ch) {
	ccc++;
}
...
Hidden Procedure addlines(register int n) {
	if (par_al_str && n > 1)
...
Hidden Procedure dellines(register int n) {
	if (par_dl_str && n > 1)
